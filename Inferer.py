...
class Inferer:
    def __init__(self, weights,yaml , device=0,img_size=640, half=False, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic_nms=False, max_det=1000):
    ...
    def infer(self,img, img_src,hide_labels=False, hide_conf=False, view_img=True):
